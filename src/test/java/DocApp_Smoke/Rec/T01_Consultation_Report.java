...
//Navigate to PE: Specific Site
        wait.until(visibilityOfElementLocated(By.cssSelector("md-menu-bar > md-menu > button > md-icon[md-font-icon*=\"stethoscope\"]")));
        ...
        wait.until(visibilityOfElementLocated(By.cssSelector("md-menu-content > md-menu-item:nth-child(3)")));

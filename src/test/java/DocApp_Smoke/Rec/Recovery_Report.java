...
//Check report values
        ...
        ArrayList<String> act_opt = new ArrayList();
            ...
            System.out.println(act_opt);
            Assert.assertEquals(exp_opt,act_opt);
...
//        try {
//            FileUtils.copyFile(scrFile, new File("C:\\Users\\Roma&Nastya\\Desktop\\Upwork\\Screenshots\\Selenium\\screenshot" +" - Post_operation_recovery_Report"+ System.currentTimeMillis() +".png"));
//        } catch (IOException x) {
//            x.printStackTrace();
//        }
    }
